...
## Issues
If you find a bug in the source code or a mistake in the documentation, you can help by submitting an [issue](https://github.com/MattDuffield/gulp-ng-ts/issues) to the repository.  Even better, you can submit a [Pull Request](#pull-requests) with a fix.

Before you submit your issue, search the [archive](https://github.com/MattDuffield/gulp-ng-ts/issues).  Maybe your question was already answered.
...
* Search for an open or closed [Pull Request](https://github.com/MattDuffield/gulp-ng-ts/pulls) that relates to your submission.  You don't want to duplicate effort.
...
```
* Send a pull request to `gulp-ng-ts:master`
